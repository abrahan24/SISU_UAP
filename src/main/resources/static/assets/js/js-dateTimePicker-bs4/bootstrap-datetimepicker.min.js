!(function (e) {
  ...
  var i = function (t, i) {
    ...
    (this.element = e(t)),
      ...
      (this.language =
        this.language in a ? this.language : this.language.split("-")[0]),
      ...
      (this.format = n.parseFormat(
        i.format ||
          this.element.data("date-format") ||
          a[this.language].format ||
          n.getDefaultFormat(this.formatType, "input"),
        this.formatType
      )),
      (this.isInline = !1),
      (this.isVisible = !1),
      ...
      (this.component =
        ...
        (3 == this.bootcssVer
          ? this.element
              .find(
                ".input-group-append .glyphicon-th, .input-group-append .glyphicon-time, .input-group-append .glyphicon-calendar, .input-group-append .glyphicon-calendar, .input-group-append .fa-calendar, .input-group-append .fa-clock-o"
              )
              .parent()
          : this.element
              .find(
      ...
      (this.componentReset =
        ...
        (3 == this.bootcssVer
          ? this.element
              .find(
                ".input-group-append .glyphicon-remove, .input-group-append .fa-times"
              )
              .parent()
          : this.element
      ...
      "navIcons" in i &&
        ...
        i.navIcons.iconType
          ? (this.icontype = i.navIcons.iconType)
          : (this.icontype = "icon")),
      this._attachEvents(),
    ...
    for (
      var h = 3 === this.bootcssVer ? n.templateV3 : n.template;
      -1 !== h.indexOf("{iconType}");
    ...
    e(document).on("mousedown", function (t) {
      ...
      (this.todayHighlight =
        i.todayHighlight || this.element.data("date-today-highlight") || !1),
      (this.weekStart =
        (i.weekStart ||
          this.element.data("date-weekstart") ||
          a[this.language].weekStart ||
          0) % 7),
  ...
  i.prototype = {
    ...
    place: function () {
      if (!this.isInline) {
        ...
        (n =
          ...
          a + 220 > document.body.clientWidth &&
            (a = document.body.clientWidth - 220),
          (s =
            "top-left" == this.pickerPosition ||
      ...
      if (null != this.date && null != this.viewDate) {
        ...
        if (
          (this.picker
            ...
            .text(a[this.language].months[h] + " " + s),
          ...
          this.picker
            ...
            .text(o + " " + a[this.language].months[h] + " " + s),
            this.picker
              .find(".datetimepicker-minutes thead th:eq(1)")
              .text(o + " " + a[this.language].months[h] + " " + s);
        this.picker
          .find("tfoot th.today")
          .text(a[this.language].today)
        ...
        for (var y, T = []; g.valueOf() < D; )
          g.getUTCDay() == this.weekStart && T.push("<tr>"),
            (y = ""),
            g.getUTCFullYear() < s ||
            (g.getUTCFullYear() == s && g.getUTCMonth() < h)
              ? (y += " old")
              : (g.getUTCFullYear() > s ||
                  (g.getUTCFullYear() == s && g.getUTCMonth() > h)) &&
                (y += " new"),
            this.todayHighlight &&
              g.getUTCFullYear() == v.getFullYear() &&
              g.getUTCMonth() == v.getMonth() &&
              g.getUTCDate() == v.getDate() &&
              (y += " today"),
            g.valueOf() == m && (y += " active"),
            (g.valueOf() + 864e5 <= this.startDate ||
              g.valueOf() > this.endDate ||
              -1 !== e.inArray(g.getUTCDay(), this.daysOfWeekDisabled)) &&
              (y += " disabled"),
        ...
        this.picker
          ...
          (T = []);
        for (
          var M = "", C = "", k = "", b = this.hoursDisabled || [], U = 0;
          U < 24;
          U++
        )
          -1 === b.indexOf(U) &&
            ((y = ""),
            (x = t(s, h, o, U)).valueOf() + 36e5 <= this.startDate ||
            x.valueOf() > this.endDate
              ? (y += " disabled")
              : r == U && (y += " active"),
            this.showMeridian && 2 == a[this.language].meridiem.length
              ? ((C =
                  U < 12
                    ? a[this.language].meridiem[0]
                    : a[this.language].meridiem[1]) != k &&
                  ("" != k && T.push("</fieldset>"),
                  T.push(
              ...
              : ((M = U + ":00"),
                T.push('<span class="hour' + y + '">' + M + "</span>")));
        this.picker.find(".datetimepicker-hours td").html(T.join("")),
          ...
          (k = "");
        for (
          var V = this.minutesDisabled || [], U = 0;
          U < 60;
          U += this.minuteStep
        )
          if (-1 === V.indexOf(U)) {
            var x = t(s, h, o, r, U, 0);
            (y = ""),
              x.valueOf() < this.startDate || x.valueOf() > this.endDate
                ? (y += " disabled")
                : Math.floor(d / this.minuteStep) ==
                    Math.floor(U / this.minuteStep) && (y += " active"),
              this.showMeridian && 2 == a[this.language].meridiem.length
                ? ((C =
                    r < 12
                      ? a[this.language].meridiem[0]
    ...
    updateNavArrows: function () {
      ...
      switch (this.viewMode) {
        ...
        case 3:
        case 4:
          this.startDate !== -1 / 0 && t <= this.startDate.getUTCFullYear()
            ? this.picker.find(".prev").css({ visibility: "hidden" })
            : this.picker.find(".prev").css({ visibility: "visible" }),
    ...
    showMode: function (e) {
      ...
      this.picker
        .find(">div")
        .hide()
        .filter(".datetimepicker-" + n.modes[this.viewMode].clsName)
        .css("display", "block"),
        this.updateNavArrows();
    },
    reset: function (e) {
      ...
      this.each(function () {
        ...
        if (
          (h ||
            n.data(
              "datetimepicker",
              (h = new i(this, e.extend({}, e.fn.datetimepicker.defaults, o)))
            ),
          "string" == typeof t &&
            "function" == typeof h[t] &&
            void 0 !== (a = h[t].apply(h, s)))
        )
          return !1;
      }),
      void 0 !== a ? a : this
      ...
      parseDate: function (s, n, h, o) {
        ...
        if (
          (/^\d{4}\-\d{1,2}\-\d{1,2}$/.test(s) &&
            (n = this.parseFormat("yyyy-mm-dd", o)),
          /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(s) &&
            (n = this.parseFormat("yyyy-mm-dd hh:ii", o)),
          /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}\:\d{1,2}[Z]{0,1}$/.test(
            s
          ) && (n = this.parseFormat("yyyy-mm-dd hh:ii:ss", o)),
      ...
      formatDate: function (t, i, s, h) {
        ...
        if ("standard" == h)
          (o = {
            ...
            p:
              2 == a[s].meridiem.length
                ? a[s].meridiem[t.getUTCHours() < 12 ? 0 : 1]
                : "",
            h: t.getUTCHours(),
            i: t.getUTCMinutes(),
            s: t.getUTCSeconds(),
          ...
          ((o = {
            ...
            S:
              t.getUTCDate() % 10 <= a[s].suffix.length
                ? a[s].suffix[(t.getUTCDate() % 10) - 1]
                : "",
            a:
              2 == a[s].meridiem.length
                ? a[s].meridiem[t.getUTCHours() < 12 ? 0 : 1]
        ...
        for (
          var t = [], r = e.extend([], i.separators), d = 0, l = i.parts.length;
          d < l;
          d++
        )
